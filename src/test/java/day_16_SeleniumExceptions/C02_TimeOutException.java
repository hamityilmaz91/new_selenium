package day_16_SeleniumExceptions;
...
public class C02_TimeOutException extends TestBase {
    ...
    public void TimeOutExceptionTest1() {
        ...
        //NO SUCH ELEMENTTEKI GIBI WEB ELEMET YINE BULUNAMIYOR AMA ONCESINDE WAIT LI BIR METOD KULLANDIGIMIZ ICIN
        ZAMANLA ALAKALI BIR ISLEM ILE SINIRLAMA YAPTIGIMIZ ICIN TIME OUT ALIYORUZ: HATTA ELEMENT OLSA DAHI
        ELEMENTI LOCATE ETMEK ICIN SURE EGER YETERLI DEGILSE YINE HATA ALMA SEBEBI
        ...
        //**************YANLIS LOCATE ALMASAK DA BU HATYI ALABILIRIZ
