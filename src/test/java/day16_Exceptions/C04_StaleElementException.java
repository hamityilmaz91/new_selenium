...
public class C04_StaleElementException extends TestBase {
    ...
    public void staleElementExceptionTest2() {
        ...
        //Locator doğru fakat adres refresh sonrası silindiği için "lmsLogin" container'ı artık kullanılamaz.
        // Yeniden locate gerekir.
    /*
    //NOT::::::::: STALE ELEMENT EXCEPTION LOCATE EDILIP OLUSTURULAN BIR WEB ELEMENT OLDUGUNU DUSUNELIM
    DRIVER.NAVIGATE.REFRESCH ;;;DRIVER.NAVIGATE.BACK;;;;DRIVER.NAVIGATE.FORWARD  KOMUTLARINDAN BIRINDEN SONRA
    BU WEB ELEMENTLE ISLEM YAPMAK ISTERSEK EGER
     */
