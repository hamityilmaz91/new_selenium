...
public class C04_FileDownloadTest extends TestBase {
    ...
    public void fileDownload() {
        ...
        File silinecekDosya = new File("C:\\Users\\Lenovo\\Downloads\\b10 all test cases, code.docx");//burasi dosyayi javada mudahale edilebilir bir hale getiriyor


        Files.exists(Path.of("C:\\Users\\Lenovo\\Downloads\\b10 all test cases, code.docx"));//Burasi ise
